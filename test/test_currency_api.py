...
class TestCurrencyApi(unittest.TestCase):
    ...
    def test_currency_get_all_currency_iso3_letter_codes(self):
        """Test case for currency_get_all_currency_iso3_letter_codes

        Get the list of currencies available in elab  # noqa: E501
        """
        pass

    def test_currency_get_all_currency_letter_codes_with_symbols(self):
        """Test case for currency_get_all_currency_letter_codes_with_symbols
